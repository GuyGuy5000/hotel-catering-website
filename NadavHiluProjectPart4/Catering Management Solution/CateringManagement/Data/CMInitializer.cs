    ...
    public static class CMInitializer
    {
        public static void Seed(IApplicationBuilder applicationBuilder)
        {
            ...
            try
            {
                ...
                //Look for custom populated customers
                if (context.Customers.Select(c => c.FirstName.ToLower() == "nadav") == null)
                {
                    context.Customers.AddRange(
                        new Customer
                        {
                        ...
                        new Customer
                        {
                            ...
                            Phone = "9999999999",
                            CustomerCode = "G9255624",
                            Email = "jkaluba@niagaracollege"
                        },
                        new Customer
                        {
                            FirstName = "David",
                            ...
                            CompanyName = "Niagara College",
                            Phone = "9999999999",
                            CustomerCode = "I2901242",
                            Email = "dstovell@niagaracollege"
                        });
                    context.SaveChanges();
                }
