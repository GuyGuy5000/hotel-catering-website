...
namespace CateringManagement.Utilities
{
    ...
    public class EmailSender : IEmailSender
    {
        ...
        {
            //only sends email to these email addresses (instructor's emails commented out for testing)
            string[] allowedAddresses = { "nhilu1@ncstudents.niagaracollege.ca", "jkaluba@niagaracollege.ca", "dstovell@niagaracollege.ca" };
            if (!allowedAddresses.Contains(email))
                return;
